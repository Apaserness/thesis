...
if G > 0
    ...
    % LF cut coefficients
    b0 = (V0*(1 + sqrt(2)*K + K^2)) / (V0 + sqrt(V0*2)*K + V0*K^2);
    b1 = (2 * V0 * (K^2 - 1)) / (V0 + sqrt(V0* 2)*K + K^2);
    b2 = (V0*(1 - sqrt(2)*K + K^2)) / (V0 + sqrt(V0*2)*K + K^2);
    a1 = (2 * (K^2 - V0)) / (V0 + sqrt(2)*K + V0*K^2);
